    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-blue-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full filter blur-[100px] animate-float"></div>
          <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-green-400 to-emerald-500 rounded-full filter blur-[120px] animate-float-delayed"></div>
          <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-gradient-to-br from-purple-400 to-pink-500 rounded-full filter blur-[100px] animate-float-slow"></div>
          <div className="absolute bottom-1/4 left-1/3 w-[300px] h-[300px] bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full filter blur-[80px] animate-pulse"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-2xl shadow-blue-500/50 transform hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                </svg>
              </div>
              <div>
                <h1 className="text-xl sm:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300">
                  Land Management System
                </h1>
                <p className="text-xs sm:text-sm text-blue-200/80 hidden sm:block font-medium">Professional Land Calculator</p>
              </div>
            </div>
            
            {/* Desktop - Right side text */}
            <div className="hidden md:flex items-center space-x-4">
              <span className="text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-cyan-300">ভূমি ব্যবস্থাপনা সিস্টেম</span>
            </div>

            {/* Mobile - Hamburger Menu Button */}
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
              className="md:hidden p-2.5 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 border border-white/10 transition-all duration-300 shadow-lg"
            >
      ...
      {/* Mobile Sidebar */}
      <div className={`fixed top-20 left-0 h-[calc(100vh-5rem)] w-80 bg-gradient-to-br from-indigo-950/98 via-purple-900/98 to-blue-950/98 backdrop-blur-2xl border-r border-white/10 z-40 transform transition-transform duration-500 ease-out md:hidden overflow-y-auto shadow-2xl ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-4 space-y-4">
          <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl hover:shadow-2xl hover:border-white/20 transition-all duration-300">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300">About</h3>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl hover:shadow-2xl hover:border-white/20 transition-all duration-300">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-emerald-300">Formula</h3>
            </div>
            <div className="space-y-3 text-sm text-green-200/90">
              ...
              <p className="text-xs text-center bg-gradient-to-r from-yellow-200 to-orange-200 text-gray-900 px-3 py-2 rounded-lg font-semibold">
                Conversion: 1 Shotok = 435.6 sq ft
              </p>
            </div>
          </div>

          <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl hover:shadow-2xl hover:border-white/20 transition-all duration-300">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-pink-300">Features</h3>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="hidden md:block lg:col-span-1 space-y-4">
              <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:shadow-blue-500/20 hover:border-white/20 transition-all duration-300 hover:scale-105">
                <div className="flex items-center space-x-3 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:shadow-green-500/20 hover:border-white/20 transition-all duration-300 hover:scale-105">
                <div className="flex items-center space-x-3 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg shadow-green-500/30">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl hover:shadow-purple-500/20 hover:border-white/20 transition-all duration-300 hover:scale-105">
                <div className="flex items-center space-x-3 mb-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/30">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
            ...
            <div className="lg:col-span-3">
              <div className="bg-white/98 backdrop-blur-sm rounded-3xl shadow-2xl shadow-blue-900/50 overflow-hidden border border-white/20 hover:shadow-blue-500/30 transition-all duration-300">
                {/* Card Header */}
                <div className="bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 px-4 sm:px-8 py-8 sm:py-10 relative overflow-hidden">
                  <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,.1)_50%,transparent_75%)] bg-[length:250%_250%] animate-shimmer"></div>
                  <h2 className="text-3xl sm:text-4xl font-black text-white text-center mb-2 drop-shadow-lg relative z-10">
                    Land Area Calculator
                  </h2>
                  <p className="text-blue-100 text-center text-sm sm:text-base font-medium relative z-10">
                    Enter measurements in feet • ফিট এ মাপ লিখুন
                  </p>
                ...
                <div className="p-4 sm:p-8 bg-gradient-to-br from-blue-50 via-white to-purple-50">
                  ...
                  <div className="relative grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 mb-8">
                    ...
                    <div className="col-start-2 row-start-2 flex items-center justify-center">
                      <div className="relative group">
                        <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-purple-600 rounded-full blur-xl opacity-75 group-hover:opacity-100 transition-opacity animate-pulse"></div>
                        <div className="relative w-16 h-16 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-1 sm:w-1.5 h-5 sm:h-6 bg-gradient-to-b from-blue-500 to-transparent rounded-full"></div>
                        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-1 sm:w-1.5 h-5 sm:h-6 bg-gradient-to-t from-green-500 to-transparent rounded-full"></div>
                        <div className="absolute top-1/2 -translate-y-1/2 -left-3 w-5 sm:w-6 h-1 sm:h-1.5 bg-gradient-to-r from-green-500 to-transparent rounded-full"></div>
                        <div className="absolute top-1/2 -translate-y-1/2 -right-3 w-5 sm:w-6 h-1 sm:h-1.5 bg-gradient-to-l from-purple-500 to-transparent rounded-full"></div>
                      </div>
                    </div>
                  ...
                  {/* Results Section */}
                  {results && (
                    <div className="bg-gradient-to-br from-blue-100 via-purple-50 to-green-100 rounded-2xl p-4 sm:p-8 border-4 border-blue-300 shadow-2xl animate-slideInBounce relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-200/20 via-transparent to-green-200/20"></div>
                      <div className="flex items-center justify-center mb-6 relative z-10">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center mr-4 shadow-lg shadow-green-500/50 animate-bounce-slow">
                          <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <h3 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-green-600">
                          Results / ফলাফল
                        </h3>
                      </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 relative z-10">
                        <div className="bg-white rounded-2xl p-5 sm:p-8 shadow-xl border-l-8 border-blue-600 hover:shadow-2xl hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                          ...
                          <p className="text-3xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800 mb-2 relative z-10">
                        ...
                        <div className="bg-white rounded-2xl p-5 sm:p-8 shadow-xl border-l-8 border-green-600 hover:shadow-2xl hover:scale-105 transition-all duration-300 relative overflow-hidden group">
                          ...
                          <p className="text-3xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-800 mb-2 relative z-10">
                            {results.shotok}
                          </p>
